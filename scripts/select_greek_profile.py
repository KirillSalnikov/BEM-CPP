...
def main():
    ...
    if args.command:
        out = (
            ...
            f"Ax{args.ax:g}_a95b65g20_q7_d6_tol5e4_n181.json"
        )
        print(
            "./bin/bem_cuda_fmm --solver fmm --accurate --system balanced "
            f"--obj {profile.mesh} --ka {args.ax:g} --ri 1.6 0.002 "
            f"--quad 7 --fmm-digits 6 --gmres-tol 5e-4 --gmres-restart 500 "
            f"--max-leaf 128 --no-prec --orient 95 65 20 --ntheta 181 --out {out}"
        )
