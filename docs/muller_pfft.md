...
sweep plot is generated by `scripts/report_pfft_inner_sweep.py`.
...
The cache benchmark and plot are generated by
`scripts/report_muller_cache.py` and stored under
`runs/muller_pfft/report_cache`.
